...
class vb_wind_waves:
    def __init__(self,parent): 
        ...
        self.master.minsize(300,350)
        self.master.geometry("400x300")

        self.master.title("vb_wind_waves_gui.py  ver 1.0  by Tom Irvine")
        ...
        self.Lb3.insert(1, "Pierson-Moskowitz Ocean Wave Spectrum")
        self.Lb3.insert(2, "Davenport-King Wind Spectrum")        
...
###############################################################################
    ...
    def analysis_go(self):
        ...
        if(n==m):
            from vb_Pierson_Moskowitz_gui import vb_Pierson_Moskowitz        
            vb_Pierson_Moskowitz(win)         

        m=m+1
        
        if(n==m):
            from vb_Davenport_King_gui import vb_Davenport_King       
            vb_Davenport_King(win)         
