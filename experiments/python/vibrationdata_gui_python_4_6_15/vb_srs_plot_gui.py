...
################################################################################
        ...
        self.hwtext4.grid(row=crow, column=0, columnspan=2, pady=7,sticky=tk.W)
                          
        crow=crow+1
        
        self.t_string=tk.StringVar()  
        self.t_string.set('Shock Response Spectrum  Q=10')  
        self.t_string_entry=tk.Entry(top, width = 40,textvariable=self.t_string)
...
################################################################################
        ...
        self.hwtext3.grid(row=crow, column=0, columnspan=2, pady=7,sticky=tk.W) 
