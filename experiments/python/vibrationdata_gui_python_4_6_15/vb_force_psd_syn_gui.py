...
class vb_force_psd_syn:
    ...
    def __init__(self,parent): 
        ...
        self.master.title("vb_force_psd_syn_gui.py ver 1.3  by Tom Irvine")         
...
#
        ...
        plt.xscale('log')
        plt.yscale('log')
        y1=10**int(floor(log10(min(self.a))))
        y2=10**int(ceil(log10(max(self.a))))
