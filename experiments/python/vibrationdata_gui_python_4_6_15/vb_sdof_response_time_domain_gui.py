...
class vb_sdof_response_time_domain:
    def __init__(self,parent): 
        ...
        self.master.title("vb_sdof_response_time_domain_gui.py  ver 1.1  by Tom Irvine")
...
###############################################################################
    ...
    def analysis_go(self):
        ...
        if(n==m):
            from vb_arbit_base_gui import vb_arbit_base         
            vb_arbit_base(win)
        m=m+1       
    
        if(n==m):
            from vb_arbit_force_gui import vb_arbit_force         
            vb_arbit_force(win)
        m=m+1          
