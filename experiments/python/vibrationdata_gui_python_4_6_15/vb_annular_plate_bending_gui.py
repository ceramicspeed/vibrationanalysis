################################################################################
# program: vb_annular_plate_bending_gui.py
# author: Tom Irvine
# version: 1.0
# date: April 9, 2014
# description:  
...
class vb_annular_plate_bending:
    ...
    def __init__(self,parent): 
        ...
        self.master.title("vb_annular_plate_bending.py ver 1.0  by Tom Irvine")    
...
################################################################################
        ...
        self.Lbu = tk.Listbox(top,height=2,width=20,exportselection=0)
...
################################################################################
    ...
    def PerformAnalysis(self):
        ...
        if(n==m):
            from vb_annular_homogeneous_gui import vb_annular_homogeneous        
            vb_annular_homogeneous(win)
        
        m=m+1
    
        if(n==m):
            from vb_annular_honeycomb_gui import vb_annular_honeycomb        
            vb_annular_honeycomb(win)
