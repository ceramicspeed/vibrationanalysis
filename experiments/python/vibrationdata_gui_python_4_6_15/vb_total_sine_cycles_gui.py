###########################################################################
# program: vb_total_sine_cycles_gui.py
# author: Tom Irvine
# version: 1.1
# date: April 27, 2014
# 
...
class vb_total_sine_cycles:
    def __init__(self,parent): 
        ...
        self.master.title("vb_total_sine_cycles_gui.py  ver 1.1  by Tom Irvine")
        ...
        self.hwtext4=tk.Label(top,text='Enter Duration (sec)')
...
###############################################################################
        ...
        self.TCr=tk.StringVar()  
        self.TC_entry=tk.Entry(top, width = 12,textvariable=self.TCr)
        self.TC_entry.grid(row=crow, column=1) 
        self.TC_entry.configure(state='readonly')        
