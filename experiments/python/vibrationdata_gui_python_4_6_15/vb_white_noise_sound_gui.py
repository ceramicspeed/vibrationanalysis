################################################################################
# program: vb_white_noise_sound_gui.py
# author: Tom Irvine
...
from numpy import zeros,max,abs,int16
...
class vb_white_noise_sound:
    ...
    def __init__(self,parent): 
        ...
        self.master.title("vb_white_noise_sound_gui.py ver 1.0  by Tom Irvine")         
